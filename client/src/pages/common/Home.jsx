...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#f7fbff] via-[#f3f7ff] to-white py-12 relative">
      ...
      <div className="max-w-6xl mx-auto px-6 space-y-10 relative z-10">
        {/* hero section */}
        <motion.section
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white/80 via-white/70 to-white/50 p-8 shadow-2xl border"
          variants={container}
          initial="hidden"
          animate="show"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <motion.div variants={fadeUp} className="space-y-6">
              <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-slate-900">
                Drives made delightful — pick a car, pick an adventure.
              </motion.h1>

              <motion.p variants={fadeUp} className="text-slate-600 max-w-xl text-lg">
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap gap-3 items-center">
                ...
                >
                  <Link to="/cars" className="inline-flex items-center gap-3 bg-gradient-to-r from-[#7c3aed] to-[#06b6d4] text-white px-5 py-3 rounded-lg text-sm font-semibold shadow-md">
                ...
                <motion.div
                  ...
                  className="inline-block"
                >
                  <Link to="/contact" className="inline-flex items-center gap-3 border border-slate-200 hover:bg-slate-50 text-slate-700 px-4 py-3 rounded-lg text-sm font-medium bg-white/60">
              ...
              <motion.div variants={fadeUp} className="mt-4 flex flex-wrap gap-3 text-sm text-slate-500">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <motion.div
                ...
                whileTap={{ scale: 0.995 }}
                transition={{ type: "spring", stiffness: 300 }}
                className="rounded-2xl p-4 shadow-2xl border bg-gradient-to-br from-[#eef2ff] to-white"
              >
                <motion.div whileHover={{ scale: 1.02 }} className="h-44 rounded-lg bg-gradient-to-br from-[#7c3aed] to-[#06b6d4] flex items-center justify-center text-white font-bold text-xl">
                  Featured: Urban SUV
                </motion.div>
              ...
              <motion.div
                ...
                className="rounded-2xl p-4 shadow-lg border bg-white"
              >
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <motion.div
            ...
            className="bg-gradient-to-br from-white to-[#f8fafc] rounded-xl border shadow-sm p-6"
          >
          ...
          <motion.div
            ...
            whileHover={{ scale: hoverScale, boxShadow: subtleShadow }}
            transition={{ duration: 0.3 }}
            className="bg-gradient-to-br from-white to-[#fff7ed] rounded-xl border shadow-sm p-6"
          >
          ...
          <motion.div
            ...
            whileHover={{ scale: hoverScale, boxShadow: subtleShadow }}
            transition={{ duration: 0.3 }}
            className="bg-gradient-to-br from-white to-[#ecfeff] rounded-xl border shadow-sm p-6"
          >
  ...
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
    {[
      ...
      >
        ...
        {/* Stats */}
        <section className="bg-gradient-to-r from-white to-[#f8fafc] rounded-2xl border shadow p-6">
